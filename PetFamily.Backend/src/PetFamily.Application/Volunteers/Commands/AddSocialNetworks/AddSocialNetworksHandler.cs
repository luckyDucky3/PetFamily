...
public record AddSocialNetworksCommand(Guid Id, List<SocialNetworkDto> SocialNetworkDtos) : ICommand;

public class AddSocialNetworksHandler : ICommandHandler<Guid, AddSocialNetworksCommand>
{
